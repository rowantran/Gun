...
public class Crate extends Terrain {
    ...
    public Crate(Vector2 position) {
        ...
        RectangularHitbox leftEdge = new RectangularHitbox(new Vector2(position.x, position.y), new Vector2(16f, 64f));
        RectangularHitbox rightEdge = new RectangularHitbox(new Vector2(position.x + getSize().x-16, position.y), new Vector2(16f, 64f));
        RectangularHitbox topEdge = new RectangularHitbox(new Vector2(position.x, position.y + getSize().y-16), new Vector2(64f, 16f));
        RectangularHitbox botEdge = new RectangularHitbox(new Vector2(position.x, position.y), new Vector2(64f, 16f));
